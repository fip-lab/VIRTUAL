...
parser.add_argument('--top_m', type=int, required=True)
...
responses_df.to_csv(os.path.join(PATHS.output_path, f'virtual_{top_m}_{top_n}_one_shot.csv'), index=False)
