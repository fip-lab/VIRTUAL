...
# Output: BxNxN , 0 
tokenizer = AutoTokenizer.from_pretrained("../../models/pretrained_models/chinese-roberta-wwm-ext-large")
...
class CAMRRelationTrainer(Trainer):
    def _prepare_inputs(self, inputs):
        # Move all inputs to CPU before moving to the specified device
